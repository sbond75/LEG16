...
-- Equation(s):
-- \U2|LessThan0~2_combout\ = (!\U2|CLK_COUNT_400HZ\(7) & (!\U2|CLK_COUNT_400HZ\(6) & (!\U2|CLK_COUNT_400HZ\(9) & !\U2|CLK_COUNT_400HZ\(8))))
...
-- Equation(s):
-- \U2|LessThan0~3_combout\ = (\U2|LessThan0~0_combout\) # ((\U2|LessThan0~2_combout\ & (!\U2|CLK_COUNT_400HZ\(11) & \U2|LessThan0~1_combout\)))
...
-- Equation(s):
-- \U2|CLK_COUNT_400HZ[14]~57_combout\ = (\SW[7]~input_o\) # (((!\U2|LessThan0~3_combout\ & !\U2|CLK_COUNT_400HZ[14]~56_combout\)) # (!\U2|CLK_COUNT_400HZ[14]~20_combout\))
...
PORT MAP (
	...
	datad => \U2|CLK_COUNT_400HZ[14]~56_combout\,
...
-- Location: LCCOMB_X11_Y43_N28
\U2|CLK_400HZ_Enable~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \U2|CLK_400HZ_Enable~0_combout\ = (!\U2|CLK_COUNT_400HZ[14]~21_combout\ & !\SW[7]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \U2|CLK_COUNT_400HZ[14]~21_combout\,
	datad => \SW[7]~input_o\,
	combout => \U2|CLK_400HZ_Enable~0_combout\);

-- Location: FF_X11_Y43_N29
...
-- Equation(s):
-- \U1|U1|CHAR_COUNT[0]~0_combout\ = (\U2|CLK_400HZ_Enable~q\ & !\SW[7]~input_o\)
...
-- Equation(s):
-- \U2|Equal2~0_combout\ = (\U2|CHAR_COUNT\(2) & (\U2|CHAR_COUNT\(3) & (\U2|CHAR_COUNT\(0) & \U2|CHAR_COUNT\(1))))
...
-- Equation(s):
-- \U2|CHAR_COUNT[4]~13_combout\ = \U2|CHAR_COUNT\(4) $ (!\U2|CHAR_COUNT[3]~12\)
...
-- Equation(s):
-- \U2|Selector16~1_combout\ = (\U2|Selector16~0_combout\) # ((\U2|Equal2~0_combout\ & (!\U2|CHAR_COUNT\(4) & \U2|state.Print_String~q\)))
...
-- Equation(s):
-- \U2|Mux4~6_combout\ = (\U2|CHAR_COUNT\(4) & (((!\U2|CHAR_COUNT\(1) & !\U2|CHAR_COUNT\(2))))) # (!\U2|CHAR_COUNT\(4) & ((\U2|CHAR_COUNT\(1) & ((!\U2|CHAR_COUNT\(2)))) # (!\U2|CHAR_COUNT\(1) & ((\U2|CHAR_COUNT\(2)) # (!\U2|CHAR_COUNT\(0))))))
...
-- Location: LCCOMB_X14_Y43_N30
\U2|Mux6~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \U2|Mux6~0_combout\ = (\U2|CHAR_COUNT\(2) & (!\U2|CHAR_COUNT\(3) & (\U2|CHAR_COUNT\(1) & !\U2|CHAR_COUNT\(4))))
...
-- Equation(s):
-- \U2|Mux4~5_combout\ = (\U2|Mux4~3_combout\) # ((\U2|Mux4~6_combout\ & !\U2|CHAR_COUNT\(3)))
...
-- Equation(s):
-- \U2|Mux5~1_combout\ = (\U2|Mux6~0_combout\ & ((\U2|Mux5~0_combout\) # ((!\U2|CHAR_COUNT\(0) & \U2|Mux4~2_combout\)))) # (!\U2|Mux6~0_combout\ & (!\U2|CHAR_COUNT\(0) & ((\U2|Mux4~2_combout\))))
...
-- Equation(s):
-- \U2|Mux3~1_combout\ = (\U2|CHAR_COUNT\(1) & (!\U2|CHAR_COUNT\(0) & ((\SW[7]~input_o\) # (!\U2|CHAR_COUNT\(2)))))
...
-- Equation(s):
-- \U2|Mux3~2_combout\ = (!\U2|CHAR_COUNT\(4) & (!\U2|CHAR_COUNT\(3) & ((\U2|Mux3~1_combout\) # (\U2|Mux3~0_combout\))))
...
-- Equation(s):
-- \U2|Mux1~0_combout\ = (\U2|CHAR_COUNT\(2) & ((\U2|CHAR_COUNT\(4)) # ((!\U2|CHAR_COUNT\(1))))) # (!\U2|CHAR_COUNT\(2) & ((\U2|CHAR_COUNT\(1)) # ((!\U2|CHAR_COUNT\(4) & \U2|CHAR_COUNT\(0)))))
...
-- Equation(s):
-- \U2|Mux0~0_combout\ = (\U2|CHAR_COUNT\(4) & ((\U2|CHAR_COUNT\(2)) # ((\U2|CHAR_COUNT\(1))))) # (!\U2|CHAR_COUNT\(4) & (\U2|CHAR_COUNT\(2) & ((\U2|CHAR_COUNT\(0)) # (\U2|CHAR_COUNT\(1)))))
...
-- Equation(s):
-- \U2|Equal0~0_combout\ = (!\U2|Mux1~0_combout\ & (!\U2|CHAR_COUNT\(3) & (\U2|Mux0~0_combout\ & \U2|Mux2~0_combout\)))
...
-- Equation(s):
-- \U2|DATA_BUS_VALUE~0_combout\ = (\U2|Mux3~2_combout\ & (\U2|Equal0~0_combout\ & ((\U2|Mux4~5_combout\) # (\U2|Mux5~1_combout\))))
...
-- Equation(s):
-- \U2|Mux4~4_combout\ = (\U2|CHAR_COUNT\(2)) # ((\U2|CHAR_COUNT\(1)) # (!\U2|CHAR_COUNT\(0)))
...
-- Equation(s):
-- \U2|Selector8~1_combout\ = \U2|Mux5~1_combout\ $ (((!\U2|Mux6~3_combout\ & \U2|DATA_BUS_VALUE~0_combout\)))
...
PORT MAP (
	...
	datac => \U2|state.HOLD~q\,
	datad => \U2|DATA_BUS_VALUE\(1),
	combout => \U2|Selector8~0_combout\);

-- Location: LCCOMB_X14_Y42_N10
\U2|Selector8~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \U2|Selector8~2_combout\ = (\U2|Selector8~0_combout\) # ((\U2|Selector8~1_combout\ & \U2|state.Print_String~q\))
...
-- Equation(s):
-- \U2|Selector7~1_combout\ = (!\U2|Mux6~3_combout\ & (!\U2|Mux5~1_combout\ & \U2|DATA_BUS_VALUE~0_combout\))
...
-- Equation(s):
-- \U2|Selector7~2_combout\ = (\U2|Selector7~0_combout\) # ((\U2|state.Print_String~q\ & (\U2|Selector7~1_combout\ $ (\U2|Mux4~5_combout\))))
...
-- Equation(s):
-- \U2|Selector6~0_combout\ = (\U2|state.FUNC_SET~q\) # ((\U2|state.RESET3~q\) # ((\U2|state.RESET2~q\) # (!\U2|Selector5~1_combout\)))
...
-- Equation(s):
-- \U2|Selector6~2_combout\ = (\U2|DATA_BUS_VALUE~0_combout\ & ((\U2|Mux6~3_combout\) # ((\U2|Mux4~5_combout\) # (\U2|Mux5~1_combout\))))
...
-- Equation(s):
-- \U2|Selector6~3_combout\ = (!\U2|Selector6~1_combout\ & ((\U2|Selector6~2_combout\ $ (!\U2|Mux3~2_combout\)) # (!\U2|state.Print_String~q\)))
...
-- Equation(s):
-- \U2|Selector5~2_combout\ = (!\U2|state.DISPLAY_CLEAR~q\ & (!\U2|state.Print_String~q\ & (\U2|Selector5~1_combout\ & \U2|Selector5~0_combout\)))
...
-- Equation(s):
-- \U2|LessThan1~0_combout\ = (\U2|Mux3~2_combout\ & ((\U2|Mux4~5_combout\) # (\U2|Mux5~1_combout\)))
...
-- Equation(s):
-- \U2|Selector3~0_combout\ = (!\U2|Mux0~0_combout\ & (!\U2|CHAR_COUNT\(3) & \U2|state.Print_String~q\))
